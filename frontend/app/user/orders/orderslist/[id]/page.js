...
const UserOrderDetails = ({ params }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.API_URL}/api/user/ordersview/${itemID}/`)
            .then((response) => {
                                ...
                                <div className="row g-0">
                                    ...
                                    <div className="col-md-8">
                                        <div className="card-body">
                                            ...
                                            <div><strong>Rs. {order.product ? order.product.amount : order.accessories.amount}</strong></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row g-0">
                                    <table className="table table-striped table-hover border">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Order Status</td>
                                                <td className='text-capitalize'>{order.order_status}</td>
